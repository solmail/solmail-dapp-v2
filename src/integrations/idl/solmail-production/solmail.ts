...
export type Solmail = {
  ...
  instructions: [
    {
      ...
      discriminator: [253, 144, 203, 42, 219, 122, 147, 97];
      accounts: [
        {
          name: "sender";
          signer: true;
    ...
    {
      name: "cancelMailBid";
      docs: ["Cancel a MAIL token bid and get refund"];
      discriminator: [24, 132, 184, 53, 189, 249, 27, 251];
      accounts: [
        {
          name: "bidAccount";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [117, 115, 101, 114, 95, 98, 105, 100];
              },
              {
                kind: "account";
                path: "bidder";
    ...
    {
      name: "cancelSolBid";
      discriminator: [95, 87, 55, 4, 23, 162, 228, 160];
      accounts: [
        {
          name: "bidAccount";
        },
    ...
    },
    {
      ...
      docs: ["Claim refund for non-winning MAIL token bidders"];
      discriminator: [238, 202, 232, 184, 130, 164, 244, 53];
      accounts: [
        {
          name: "bidAccount";
        },
    ...
    {
      name: "claimSolRefund";
      docs: ["Claim refund for non-winning SOL bidders"];
      discriminator: [79, 83, 6, 173, 51, 174, 186, 93];
      accounts: [
        {
          name: "bidAccount";
        },
    ...
    },
    {
      ...
      discriminator: [67, 86, 239, 149, 229, 62, 252, 65];
      accounts: [
        {
          name: "bidAccount";
          writable: true;
        ...
        },
        {
          ...
          docs: ["Treasury token account to receive winning bid tokens"];
          writable: true;
          optional: true;
        },
        {
    ...
    },
    {
      ...
      discriminator: [136, 118, 43, 141, 107, 8, 33, 116];
      accounts: [
        {
          name: "bidAccount";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Create collection master edition"];
    ...
    },
    {
      ...
      docs: ["Create collection metadata"];
    ...
    },
    {
      ...
      discriminator: [85, 64, 174, 73, 171, 122, 69, 139];
      accounts: [
        {
          name: "bidAccount";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Create or initialize enhanced marketplace settings (admin only)"];
    ...
    {
      name: "createSolBid";
      docs: ["Create a new SOL bid for a username with fixed fee collection"];
      discriminator: [84, 105, 9, 66, 182, 174, 149, 34];
      accounts: [
        {
          name: "bidAccount";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Create Solmail NFT collection (one-time setup)"];
    ...
    },
    {
      ...
      discriminator: [18, 121, 227, 225, 152, 72, 70, 216];
      accounts: [
        {
          name: "authority";
    ...
    },
    {
      ...
      discriminator: [121, 121, 158, 178, 133, 34, 78, 86];
      accounts: [
        {
          name: "marketplaceSettings";
          pda: {
    ...
    },
    {
      ...
      docs: ["Initialize marketplace treasury for SOL payments (admin only)"];
      discriminator: [195, 26, 174, 10, 130, 208, 16, 131];
      accounts: [
        {
          name: "marketplaceSettings";
          pda: {
    ...
    },
    {
      ...
      docs: ["Link a mailbox to an existing username"];
    ...
    },
    {
      ...
      discriminator: [98, 210, 179, 157, 6, 65, 213, 160];
      accounts: [
        {
          name: "mail";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [58, 75, 106, 67, 205, 68, 39, 179];
      accounts: [
        {
          name: "marketplaceSettings";
          docs: [
    ...
    },
    {
      ...
      discriminator: [255, 31, 125, 8, 209, 6, 110, 104];
      accounts: [
        {
          name: "marketplaceTreasury";
          docs: [
    ...
    },
    {
      ...
      docs: ["Transfer username authority to a new owner"];
    ...
    {
      name: "updateMailBid";
      docs: ["Update an existing MAIL token bid with a higher amount"];
      discriminator: [198, 226, 235, 73, 117, 122, 24, 239];
      accounts: [
        {
          name: "bidAccount";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Update existing enhanced marketplace settings(admin only)"];
    ...
    {
      name: "updateSolBid";
      docs: ["Update an existing SOL bid with a higher amount"];
      discriminator: [119, 190, 162, 119, 96, 53, 74, 159];
      accounts: [
        {
          name: "bidAccount";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Withdraw SOL from marketplace treasury (admin only)"];
      discriminator: [54, 251, 139, 174, 186, 22, 181, 143];
      accounts: [
        {
          name: "marketplaceTreasury";
          writable: true;
    ...
    {
      name: "wrapUsername";
      docs: ["Wrap a username as an NFT"];
  ...
  accounts: [
    ...
    {
      name: "marketplaceTreasury";
      discriminator: [2, 62, 171, 100, 3, 18, 90, 227];
    },
    {
      name: "solMail";
    ...
    {
      name: "userBid";
      discriminator: [13, 209, 228, 159, 155, 166, 149, 53];
    },
    {
      name: "userRateLimit";
  ...
  events: [
    ...
    },
    {
      ...
      discriminator: [255, 22, 213, 108, 30, 101, 237, 210];
    },
    {
      name: "bidParametersChangedEvent";
      discriminator: [110, 73, 158, 25, 134, 72, 105, 185];
    },
    {
      name: "bidRefundEvent";
    ...
    },
    {
      ...
      discriminator: [245, 13, 92, 176, 132, 250, 64, 253];
    },
    {
    ...
    },
    {
      ...
      discriminator: [218, 100, 18, 33, 113, 107, 164, 205];
    },
    {
    ...
    },
    {
      ...
      discriminator: [98, 51, 238, 228, 63, 5, 139, 199];
    },
    {
      name: "feeRateChangedEvent";
      discriminator: [198, 44, 78, 81, 101, 68, 130, 79];
    },
    {
    ...
    },
    {
      ...
      discriminator: [20, 63, 174, 134, 143, 31, 188, 234];
    },
    {
    ...
    },
    {
      ...
      discriminator: [20, 8, 193, 138, 70, 16, 245, 166];
    },
    {
    ...
    },
    {
      ...
      discriminator: [56, 187, 6, 159, 22, 32, 58, 175];
    },
    {
      name: "rateLimitParametersChangedEvent";
      discriminator: [111, 148, 192, 14, 255, 206, 118, 140];
    },
    {
    ...
    },
    {
      ...
      discriminator: [117, 163, 237, 195, 200, 247, 236, 72];
    },
    {
      name: "userBidsCleanupEvent";
      discriminator: [165, 93, 217, 22, 189, 6, 70, 240];
    },
    {
  ...
  types: [
    ...
    {
      name: "bidAccount";
      docs: ["Fixed-size fields first for efficient querying"];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "marketplaceTreasury";
      docs: ["Simple PDA account for SOL treasury"];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "userBid";
      docs: ["Individual UserBid account - one per (user, bid_account) pair"];
      type: {
        kind: "struct";
        fields: [
          {
